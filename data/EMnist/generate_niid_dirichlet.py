...
def main():
    ...
    parser.add_argument("--alpha", type=float, default=1, help="alpha in Dirichelt distribution (smaller means larger heterogeneity)")
    ...
    def process_user_data(mode, data, n_sample, SRC_CLASSES, Labels=None, unknown_test=0):
        ...
        data_path=f'./data/EMnist/{path_prefix}/{mode}'
