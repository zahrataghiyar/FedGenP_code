...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset", type=str, default="CelebA-user25-agg10")
    parser.add_argument("--algorithms", type=str, default="FedGenP, FedGen, FedAvg, FedProx", help='algorithm names separate by comma')
    ...
    parser.add_argument("--times", type=int, default=2, help='number of random seeds, starting from 1.')
