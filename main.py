...
from FLAlgorithms.servers.serverFedGenP import FedGenP
...
def create_server_n_user(args, i):
    ...
    elif ('FedGenP' in args.algorithm):
        server = FedGenP(args, model, i)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset", type=str, default= "EMnistu20c10-alpha0.1-ratio1")#'CelebA-user25-agg10')  #"cwrus2u10c4-alpha100")
    #parser.add_argument("--dataset", type=str, default="Mnistu20c10-alpha0.1-ratio0.5")
